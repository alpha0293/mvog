                        ...
                        <div class="card-body table-responsive p-0">
                          <table class="table table-hover text-nowrap table-bordered">
                            <tbody>
                             ...
                             <tr>
                              <td style="width:50%">
                                <a class="float-left">Trường học</a> <b class="float-right"><input name="school" type="text" class="form-control thongtin" disabled value="{{$dutu->scholl}}" placeholder="Chưa có"></b> 
                              </td>
                              <td style="width:50%">
