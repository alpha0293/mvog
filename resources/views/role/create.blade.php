                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="" style="margin: 0 0 10px 0;">
                                                    <input type="checkbox" class="make-switch" data-size="mini" name="permissions[]" value="{{ $permission->id }}"> {{ $permission->display_name }} <em style="margin-left: 15px;">({{ $permission->description }})</em>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
